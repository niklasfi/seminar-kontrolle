...
\section{Definitionen}
	...
	\section{Gram'sche Kontrollmatrix}\label{Gram'sche Kontrollmatrix}
		...
		eispiel wie anfangs ein Raumfahrzeug gesteuert werden sollte, so sorgt diese
		Anformderung dafür, dass möglichst wenig Energie für die Steuerung verbraucht
		wird.
\newpage
\printbibliography
\newpage
