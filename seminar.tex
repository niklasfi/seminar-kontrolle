...
\section{Definitionen}
	...
	\subsection*{Eigenschaften}
		...
		\begin{enumerateBew}
			...
			\]
			\item 
				Erinnern wir uns zunächst an die Vektorraumeigenschaft von homogenen Differentialgleichungen wie in \cite{KriegWalcher2010}[S. 43] beschrieben. Für uns interessant ist, dass die Abbildung die einem Anfangswert eine Lösungsfunktion zuordnet ein Isomorphismus ist. Wenn also die Funktion $\Phi$ das Anfangswertproblem \[
