...
\begin{Bemerkung}
Im Gegensatz zum zeitunabhängigen Fall ist jetzt nur noch eine Folgerung gegeben. Und statt vorher nur "die ersten" $n$ Matrizen $A^0B, \dots A^{n-1}B$ zu prüfen, muss man jetzt mehr Freiheiten für die Wahl der Matrizen BLBLABA. Die Forderung ist jedoch notwendig. Sei z.B.  $T_0=0, T_1=1, \;n=m=1 $ und $ A(t)=0, B(t)=t.$ Dann ist $B_0(t)=t, \;  B_1(t)=\dot B_0(t)-A(t)\cdot B_0(t)= B_0(t)=1$ und $B_i(t)=0 \; \forall i >1$. 
