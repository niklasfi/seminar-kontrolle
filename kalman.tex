...
Ob dann die Kontrollierbarkeit auch nicht von der Zeit abhängt oder welche Rolle die Wahl des Start- und Endpunktes spielen, ist noch von vorneherein klar. %TODO Satzbau
...
\begin{Beispiel}
	...
	Da $A=0$ gilt, ist die Resolvente $R(T,\tau)=\begin{pmatrix} 1 & 0 \\ 0 & 1 \end{pmatrix}=Id_2.$
	\begin{align*}
