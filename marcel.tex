...
Sei ein zeitunabhängiges lineare Kontrollsystem gegeben durch die
Matrizen
\[
A=\begin{pmatrix}1 & 0\\
0 & 1
...
Das heißt $\text{\ensuremath{\mathcal{R}}(t) ist der Menge der Zustände (oder Punkte), die von \ensuremath{x_{0}=0}}$
...
die Lösung des Anfangswertproblems die Lösungsbahn des Anfangswertproblems \[
